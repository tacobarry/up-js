...
We Love Dev:
- [Zero to Hero JavaScript - Variáveis](file:///home/guilhermemichellan/workspace/treinamentos/js/we-love-dev-blog/src/views/articles/zero-to-hero-javascript-variaveis.html)
- [Zero to Hero JavaScript - Hoisting](http://www.welovedev.com.br/post/zero-to-hero-javascript-hoisting.html)
- [Zero to Hero JavaScript - Strict mode](http://www.welovedev.com.br/post/zero-to-hero-javascript-strict-mode.html)

Programação Funcional - Tudo o Que Você Precisa Saber! (Serie de 10 artigos)
- [JavaScript Funcional](https://hcode.com.br/blog/programacao-funcional-javascript-conceito)
...
```
{
    var organizacao = 'Sensedia | JavaScript Full Stack';
}

console.log(organizacao);

 // $ Sensedia | JavaScript Full Stack
...
``` 
{
    organizacao = 'Trilha Sensedia Developer | Full Stack JavaScript';
}
 ```

> console.log(organizacao);

> // $ Trilha Sensedia Developer | Full Stack JavaScript

Vale salientar que variáveis definidas com let ou const ***"não sofrem hoisting"***.

Caso possua dúvidas sobre este comportamento, fica aqui uma sugestão do artigo sobre Hoisting que será passado ou este vídeo do canal Aulas de Programação.
...
```
{
    ...
    var name = 'Trilha Sensedia Developer | Full Stack JavaScript';
}
```
> console.log(name);
...
```
{
    let name = 'Trilha Sensedia Developer | Full Stack JavaScript';
    console.log(name);
    // $ Trilha Sensedia Developer | Full Stack JavaScript
}
...
###### [Material adaptado Zero to Hero JavaScript by Renan Johannsen](https://github.com/RenanJPaula/zero-to-hero-fullstack-javascript)
